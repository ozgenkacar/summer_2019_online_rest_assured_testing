...
public class CalendarificationTestAPIKey {
    ...
    @Test
    @DisplayName("Verify taht user cannot access web service without valid API key")
    public void test1(){
        given().
...
@Test
public void test2(){
        given().accept(ContentType.JSON).queryParam("api_key","2566957382c84fc09b286db9885d938e46475ce9").
                when().
                get("/countries").prettyPeek().
                then().
                assertThat().
                statusCode(200).
                statusLine(containsString("OK")).body("response.countries",not(empty()));
}

...
public class MetaWeatherJsonPathTests {
     ...
     */
    @Test   ///api/location/search/?query=san
    @DisplayName("Verify that are 5 cities that are matching 'New'")

    public void test1() {
        List<String> list1 = given().accept(ContentType.JSON).
    ...
    public void test1_1() {
        given().accept(ContentType.JSON).
                ...
                assertThat().statusCode(200).body("", hasSize(5)).log().body(true);
    }
//  test2
    ...
    public void test3() {
        given().accept(ContentType.JSON).
                queryParam("query", "New").
                when().get("/search").then().
                assertThat().statusCode(200).body("title", hasItems("Glaskov", "Dallas", "Las Vegas"));
    }
    ...
    public void test3_2() {
        JsonPath json =
                given().
                        ...
                        get("/search").
                        thenReturn().prettyPeek().jsonPath();
        List<String> actualTitles = json.getList("title", String.class);
        List<String> expectedTitles = List.of("Glasgow", "Dallas", "Las Vegas");
    ...
    public void test4() {
        ...
        given().
                ...
                then().
                assertThat().
                body("location_type", everyItem(is("City"))).log().all(true);
...
@Test
    ...
    Response response = given().accept(ContentType.JSON).
            ...
            when().
            get("/location/{woeid}");//prettypeek eklersek hepsini yazdiriyor

...
//        POST /api/teams/team
    ...
    public void test6_(){
        given().
                ...
                queryParam("campus-location","VA").
                queryParam("batch-number",12).
                queryParam("team-name","WhereIsShift").
                when().
                post("/api/teams/team").
                then().
                assertThat().
...
//        POST /api/teams/team
    ...
    public void test5(){
        ...
        given().auth().oauth2(APIUtilities.getTokenForBookit("teacher")).
                queryParam("first-name","ozgen").
                queryParam("last-name","kcr").
                queryParam("email","ozgen@email.com").
                ...
                accept(ContentType.JSON).
                when().
                post("/api/students/student").then().
                assertThat().
                statusCode(201).log().all(true);
    }
    @Test
    @DisplayName("Create new student")
    public void test9(){
